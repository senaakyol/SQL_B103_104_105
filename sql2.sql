...
ders_adi varchar(30),
yazili_notu int,
CONSTRAINT notlar1_fk FOREIGN KEY (talebe1_id) REFERENCES talebeler1(id)
on delete cascade
);
...
DELETE FROM notlar1 WHERE talebe1_id ='123';
...
--Musteriler tablosundan urun ismi orange, apple veya apricot olan tüm datalari listeleyiniz
...
SELECT * FROM musteriler WHERE urun_isim ='Orange' and urun id =10
...
--Calisanlar tablosundaki maas'ların toplamını listeleyiniz
SELECT sum(maas) FROM calisanlar2

--Calisanlar tablosundaki maas'ların ortalamasını listeleyiniz
...
-- VIEW Kullanımı
/*
	Yaptıgımız sorguları hafızaya alır ve tekrar bizden istenen sorgulama yerine
	view'e atadığımız ismi SELECT komutuyla çağırır.
*/
