...
--SORU4: arac tablosunda kac tane arac oldugunu listele
...
--maasa gore büyükten küçüğe sıralayarak sorgulayınız
...
-- SORU8: meslekler tablosunda en yüksek maaşı alan
-- 4. 5. 6. kişilerin bilgilerini listele
...
-- SORU1: Tüm film_name'leri, category'lerini ve filimlerde
-- oynayan actor_name'leri listeleyiniz.
