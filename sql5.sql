...
Eger gruplamadan sonra bir şart varsa having komutu kullanilir.
Where ile aynı mantıkta kullanılır.
*/
--soru2: Her sirketin MIN maaslarini eger 4000’den buyukse goster

SELECT sirket, min(maas) as en_dusuk_maas FROM personel
GROUP BY sirket
HAVING min(maas)>4000

-- 3) Ayni isimdeki kisilerin aldigi toplam gelir 10000 liradan fazla ise ismi
...
SELECT sehir, max(maas) AS en yuksek maas FROM personel
GROUP BY sehir
...
--EXCEPT KULLANIMI
/*
İki sorgulamada harici bir sorgulama istenirse
*/
